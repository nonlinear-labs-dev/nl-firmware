...
class TransitionTimeValueEdit extends Label implements QuantizedClippedValue.ChangeListener {
	...
	public void onQuantizedValueChanged(Initiator initiator, double oldQuantizedValue, double newQuantizedValue) {
		if (initiator == Initiator.EXPLICIT_USER_ACTION)
			NonMaps.theMaps.getServerProxy().setTransitionTime(newQuantizedValue);
