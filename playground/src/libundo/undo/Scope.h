...
namespace UNDO
{
  ...
  class Scope : public ContentSection
  {
    public:
      ...
      template<typename ...tArgs>
      tTransactionScopePtr startContinuousTransaction (void *id, steady_clock::duration timeout, const Glib::ustring &format, const tArgs&... args)
        {
      ...
      template<typename ...tArgs>
        ...
        {
          return startContinuousTransaction (id, getStandardContinuousTransactionTimeout(), StringTools::formatString (format, args...));
        }

        tTransactionScopePtr startContinuousTransaction (void *id, steady_clock::duration timeout, const Glib::ustring &name);
