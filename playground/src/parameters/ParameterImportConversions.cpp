...
ParameterImportConversions::ParameterImportConversions (bool registerDefaults)
{
  if (registerDefaults)
  {
    registerConverter (71, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerConverter (101, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerConverter (181, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerConverter (164, 3, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerMCAmountConverter(71, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerMCAmountConverter (101, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerMCAmountConverter (181, 2, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerMCAmountConverter (164, 3, [=](tControlPositionValue v)
    {
      return driveV2ToV3(v);
    });

    registerConverter (0, 2, [=](tControlPositionValue v)
    {
      return attackV2ToV3(v);
    });

    registerConverter (19, 2, [=](tControlPositionValue v)
    {
      return attackV2ToV3(v);
    });

    registerConverter (38, 2, [=](tControlPositionValue v)
    {
      return attackV2ToV3(v);
    });

    registerConverter (2, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (6, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (21, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (25, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (40, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (44, 2, [=](tControlPositionValue v)
    {
      return decayV2ToV3(v);
    });

    registerConverter (10, 2, [=](tControlPositionValue v)
    {
      return releaseV2ToV3(v);
    });

    registerConverter (29, 2, [=](tControlPositionValue v)
    {
      return releaseV2ToV3(v);
    });

    registerConverter (46, 2, [=](tControlPositionValue v)
    {
      return releaseV2ToV3(v);
    });
    ...
    registerMCAmountConverter (127, 4, [=](tControlPositionValue v)
    {
      return v / 2.0;
    });
    ...
    registerConverter (240, 4, [=](tControlPositionValue v)
    {
      return 0.25 + v * 0.75;
    });
...
void ParameterImportConversions::registerConverter (const tParameterID parameterID, const tFileVersion srcVersion, tConverter c)
{
  m_converters[parameterID].from[srcVersion] = c;
}

void ParameterImportConversions::registerMCAmountConverter (const tParameterID parameterID, const tFileVersion srcVersion, tConverter c)
{
  m_mcAmountConverters[parameterID].from[srcVersion] = c;
}

tControlPositionValue ParameterImportConversions::convert (const tParameterID parameterID, const tControlPositionValue in,
...
tControlPositionValue ParameterImportConversions::convertMCAmount (const tParameterID parameterID, const tControlPositionValue in,
                                                                   const tFileVersion inVersion) const
{
...
void ParameterImportConversions::registerTests ()
{
  g_test_add_func ("/ParameterImportConversions/a", []()
  {
    ...
    a.registerConverter(10, 4, [](tControlPositionValue v)
        {
          return v * 2;
        });

    a.registerConverter(10, 7, [](tControlPositionValue v)
        {
          return v * 4;
        });
