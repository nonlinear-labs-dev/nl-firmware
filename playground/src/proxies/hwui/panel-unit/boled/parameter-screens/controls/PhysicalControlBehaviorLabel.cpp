...
PhysicalControlBehaviorLabel::PhysicalControlBehaviorLabel (const Rect &pos) : Label (pos)
{
...
void PhysicalControlBehaviorLabel::setParameter (Parameter * param)
{
  if (param)
  {
    ...
    m_paramConnection = param->onParameterChanged (
                          sigc::mem_fun (this, &PhysicalControlBehaviorLabel::onParamValueChanged));
  }
}
