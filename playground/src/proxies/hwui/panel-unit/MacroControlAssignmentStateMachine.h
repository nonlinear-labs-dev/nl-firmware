...
{
  MCPressedWhileSelected, MCPressedWhileUnselected, MCReleased, ModParamPressed, ModParamReleased
};

enum class MacroControlAssignmentStates
{
  Initial, Selected, Armed, Assign, SelectSource
};

class MacroControlAssignmentStateMachine : public StateMachine<MacroControlAssignmentStates, MacroControlAssignmentEvents,
    MacroControlAssignmentStates::Initial, MacroControlAssignmentStates::Initial>
{
  private:
    using super = StateMachine<MacroControlAssignmentStates, MacroControlAssignmentEvents, MacroControlAssignmentStates::Initial, MacroControlAssignmentStates::Initial>;
