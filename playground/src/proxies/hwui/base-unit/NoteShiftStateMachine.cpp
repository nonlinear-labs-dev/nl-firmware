    ...
    m_minusButtonState (false)
{
  ...
  registerTraversal (NOTE_SHIFT_STATE_INITIAL, NOTE_SHIFT_EVENT_PLUS_PRESSED, NOTE_SHIFT_STATE_WAIT_FOR_INC_OCTAVE_OR_DEC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_INC_OCTAVE_OR_DEC_SEMITONE, NOTE_SHIFT_EVENT_PLUS_RELEASED, NOTE_SHIFT_STATE_INC_OCTAVE);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_INC_OCTAVE_OR_DEC_SEMITONE, NOTE_SHIFT_EVENT_MINUS_PRESSED, NOTE_SHIFT_STATE_DEC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_DEC_SEMITONE, NOTE_SHIFT_EVENT_MINUS_RELEASED, NOTE_SHIFT_STATE_WAIT_FOR_DEC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_DEC_SEMITONE, NOTE_SHIFT_EVENT_RESET_TIMEOUT, NOTE_SHIFT_STATE_RESET);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_DEC_SEMITONE, NOTE_SHIFT_EVENT_MINUS_PRESSED, NOTE_SHIFT_STATE_DEC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_DEC_SEMITONE, NOTE_SHIFT_EVENT_PLUS_RELEASED, NOTE_SHIFT_STATE_INITIAL);

  registerTraversal (NOTE_SHIFT_STATE_INITIAL, NOTE_SHIFT_EVENT_MINUS_PRESSED, NOTE_SHIFT_STATE_WAIT_FOR_DEC_OCTAVE_OR_INC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_DEC_OCTAVE_OR_INC_SEMITONE, NOTE_SHIFT_EVENT_MINUS_RELEASED, NOTE_SHIFT_STATE_DEC_OCTAVE);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_DEC_OCTAVE_OR_INC_SEMITONE, NOTE_SHIFT_EVENT_PLUS_PRESSED, NOTE_SHIFT_STATE_INC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_INC_SEMITONE, NOTE_SHIFT_EVENT_PLUS_RELEASED, NOTE_SHIFT_STATE_WAIT_FOR_INC_SEMITONE);
  registerTraversal (NOTE_SHIFT_STATE_INC_SEMITONE, NOTE_SHIFT_EVENT_RESET_TIMEOUT, NOTE_SHIFT_STATE_RESET);
  registerTraversal (NOTE_SHIFT_STATE_WAIT_FOR_INC_SEMITONE, NOTE_SHIFT_EVENT_PLUS_PRESSED, NOTE_SHIFT_STATE_INC_SEMITONE);
