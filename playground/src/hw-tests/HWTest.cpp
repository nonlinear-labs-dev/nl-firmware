...
void HWTest::execute ()
{
  ...
  else
  {
    ...
    g_spawn_async_with_pipes (Application::get ().getOptions ()->getHardwareTestsFolder ().c_str (), argv, NULL, (GSpawnFlags) 0, NULL,
        NULL, &m_child_pid, &stdIn, &stdOut, &stdErr, &error);
