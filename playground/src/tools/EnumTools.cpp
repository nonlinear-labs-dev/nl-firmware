...
ENUM(TestButtons, uint16_t, FIRST_PARAMETER_BUTTON = 0, BUTTON_0 = 0, BUTTON_1, BUTTON_2, BUTTON_3, BUTTON_4, BUTTON_5,
     ...
     LAST_PARAMETER_BUTTON = 95, BUTTON_SETUP = 96, BUTTON_SOUND = 97, BUTTON_A = 98, BUTTON_B = 99, BUTTON_C = 100,
     BUTTON_D = 101, BUTTON_STORE = 102, BUTTON_PRESET = 103, BUTTON_INFO = 104, BUTTON_FINE = 105, BUTTON_ENTER = 106,
