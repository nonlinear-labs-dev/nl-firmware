...
{
  appendParameter(new Parameter(this, {247, getVoiceGroup()}, ScaleConverter::get<ParabolicGainDbScaleConverter>(), 0.5, 100, 1000));

  appendParameter(new Parameter(this, {248, getVoiceGroup()}, ScaleConverter::get<LinearBipolar48StScaleConverter>(), 0, 48, 4800));
}
