...
{
  appendParameter (new ModulateableParameter (this, 113, ScaleConverter::get<Linear100PercentScaleConverter> (), 0.0, 100, 1000));

  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 115, ScaleConverter::get<PitchCombLinearStScaleConverter> (),
          ScaleConverter::get<PitchCombLinearStModulationScaleConverter> (), 0.5, 120, 12000));

  appendParameter (new Parameter (this, 117, ScaleConverter::get<Fine105PercentScaleConverter> (), 100.0 / 105.0, 105, 10500));

  appendParameter (new Parameter (this, 118, ScaleConverter::get<FineBipolar80StScaleConverter> (), 0, 80, 8000));

  appendParameter (new ModulateableParameter (this, 119, ScaleConverter::get<CombDecayBipolarMsScaleConverter> (), 0, 100, 1000));
  ...
  appendParameter (new ModulateableParameter (this, 305, ScaleConverter::get<Linear100PercentScaleConverter> (), 0, 100, 1000));

  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 123, ScaleConverter::get<Linear0To140StScaleConverter> (),
  ...
  appendParameter (new ModulateableParameter (this, 127, ScaleConverter::get<Linear100PercentScaleConverter> (), 0.5, 100, 1000));

  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 129, ScaleConverter::get<Linear40To140StScaleConverter> (),
  ...
  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 133, ScaleConverter::get<LinearBipolar100PercentScaleConverter> (),
