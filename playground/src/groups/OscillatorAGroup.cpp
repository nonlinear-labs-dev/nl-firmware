...
OscillatorAGroup::OscillatorAGroup(ParameterDualGroupSet *parent, VoiceGroup voicegroup)
    : ParameterGroup(parent, "Osc A", "Oscillator A", "Oscillator A", "Oscillator A", voicegroup)
{
}
