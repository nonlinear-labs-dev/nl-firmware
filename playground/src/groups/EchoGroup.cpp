...
void EchoGroup::init ()
{
  appendParameter (new ModulateableParameter (this, 225, ScaleConverter::get<Parabolic2000MsScaleConverter> (), 0.433, 200, 2000));

  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 227, ScaleConverter::get<LinearBipolar33PercentScaleConverter> (),
          ScaleConverter::get<LinearBipolar66PercentScaleConverter> (), 0, 66, 660));

  appendParameter (new ModulateableParameter (this, 229, ScaleConverter::get<Linear100PercentScaleConverter> (), 0.5, 100, 1000));
  ...
  appendParameter (new ModulateableParameter (this, 233, ScaleConverter::get<Linear100PercentScaleConverter> (), 0, 100, 1000));
}
