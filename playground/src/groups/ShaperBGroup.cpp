...
ShaperBGroup::ShaperBGroup (ParameterGroupSet *parent) :
...
void ShaperBGroup::init ()
{
  ...
  ScaleConverter::get<Linear50DbScaleConverter> (), ScaleConverter::get<LinearBipolar50DbScaleConverter> (), 0.2, 100, 500));
  ...
  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 106,
