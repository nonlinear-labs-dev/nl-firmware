...
void SVFilterGroup::init ()
{
  ...
  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 138,
  ...
  ScaleConverter::get<Linear20To140StScaleConverter> (), ScaleConverter::get<LinearBipolar120StScaleConverter> (), 0.5, 120, 1200));
  ...
  ScaleConverter::get<LinearBipolar60StScaleConverter> (), ScaleConverter::get<LinearBipolar120StScaleConverter> (), 0.2, 60, 600));
  ...
  appendParameter (
      new ModulateableParameterWithUnusualModUnit (this, 153,
