...
static Job *createJob (const string &line, Job *parent)
{
  ...
  {
    { "start-playground", [](Job* parent, const string& cmd)
      {
        return new StartPlaygroundJob(parent);
      }
    },
    { "set-defaults", [](Job* parent, const string& cmd)
      {
        return new SetDefaultsJob(parent);
      }
    },
    {
      "set-parameter", [](Job* parent, const string& cmd)
      {
        return new SetParameterJob(parent, cmd);
      }
    },
    {
      "set-modulation-source", [](Job* parent, const string& cmd)
      {
        return new SetModulationSourceJob(parent, cmd);
      }
    },
    {
      "set-modulation-amount", [](Job* parent, const string& cmd)
      {
        return new SetModulationAmountJob(parent, cmd);
      }
    },
    {
      "expect-parameter", [](Job* parent, const string& cmd)
      {
        return new ExpectParamaterJob(parent, cmd);
      }
    },
    {
      "sleep", [](Job* parent, const string& cmd)
      {
        return new SleepJob(parent, cmd);
      }
    },
    {
      "select-parameter", [](Job* parent, const string& cmd)
      {
        return new SelectParameterJob(parent, cmd);
      }
    },
    {
      "//", [](Job* parent, const string& cmd)
      {
        return new CommentJob(parent, cmd);
      }
    }
  };
