...
void ae_svfilter_proto::apply(const FloatVector &_sampleA, const FloatVector &_sampleB, const FloatVector &_sampleComb,
                              SignalStorage &signals)
{
  ...
  auto omega = signals.get<Signals::SVF_F1_CUT>() * m_warpConst_2PI;
