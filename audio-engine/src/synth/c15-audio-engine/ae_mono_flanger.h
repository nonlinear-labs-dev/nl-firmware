  ...
  class MonoFlanger
  {
   ...
   private:
    ...
    float
        // prewarp
        m_warpConst_PI,
        m_warpConst_2PI, m_freqClip_min, m_freqClip_max,
        // 1 pole lowpass
        ...
        // 2 Hz lowpass
        m_lp2hz_b0, m_lp2hz_stateVar_TL, m_lp2hz_stateVar_TR, m_lp2hz_stateVar_D,
        // 4 pole allpass
        m_ap_b0_L, m_ap_b1_L, m_ap_b0_R, m_ap_b1_R, m_ap_StateVar_L1, m_ap_StateVar_R1, m_ap_StateVar_L2,
        m_ap_StateVar_R2, m_ap_StateVar_L3, m_ap_StateVar_R3, m_ap_StateVar_L4, m_ap_StateVar_R4, m_ap_StateVar_L5,
        m_ap_StateVar_R5, m_ap_StateVar_L6, m_ap_StateVar_R6, m_ap_StateVar_L7, m_ap_StateVar_R7, m_ap_StateVar_L8,
        m_ap_StateVar_R8,
        // delay buffer
