...
struct Parameters
{
  ...
  inline std::vector<uint32_t> &getClockIds(uint32_t _clockType, uint32_t _polyType)
  {
  ...
  inline std::vector<uint32_t> &getPostIds(uint32_t _spreadType, uint32_t _clockType, uint32_t _polyType)
  {
