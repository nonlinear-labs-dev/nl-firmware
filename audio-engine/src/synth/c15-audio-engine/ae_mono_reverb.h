...
namespace Engine
{
  class MonoReverb
  {
   ...
   private:
    ...
    float m_mod_1a, m_mod_2a, m_mod_1b, m_mod_2b, m_lfo_omega_1, m_lfo_omega_2, m_lfo_stateVar_1, m_lfo_stateVar_2,
        m_depth, m_warpConst_PI, m_omegaClip_max, m_lp_a0, m_lp_a1, m_lp_omega, m_hp_a0, m_hp_a1, m_hp_omega,
        m_lp_stateVar_L, m_lp_stateVar_R, m_hp_stateVar_L, m_hp_stateVar_R, m_fb_amnt, m_absorb, m_bal_half, m_bal_full,
        m_preDel_L, m_preDel_R, m_stateVar_L1, m_stateVar_R1, m_stateVar_L2, m_stateVar_R2, m_stateVar_L3,
        m_stateVar_R3, m_stateVar_L4, m_stateVar_R4, m_stateVar_L5, m_stateVar_R5, m_stateVar_L6, m_stateVar_R6,
        m_stateVar_L7, m_stateVar_R7, m_stateVar_L8, m_stateVar_R8, m_stateVar_L9, m_stateVar_R9, m_smooth_inc,
        m_depth_inc, m_depth_ramp, m_depth_target, m_depth_base, m_depth_diff, m_size, m_size_ramp, m_size_target,
        m_size_base, m_size_diff, m_bal, m_bal_ramp, m_bal_target, m_bal_base, m_bal_diff, m_preDel_L_ramp,
        m_preDel_L_target, m_preDel_L_base, m_preDel_L_diff, m_preDel_R_ramp, m_preDel_R_target, m_preDel_R_base,
        m_preDel_R_diff, m_lp_omega_ramp, m_lp_omega_target, m_lp_omega_base, m_lp_omega_diff, m_hp_omega_ramp,
        m_hp_omega_target, m_hp_omega_base, m_hp_omega_diff;
