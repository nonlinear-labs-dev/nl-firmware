...
public class	ProtoParameterFactory = {
    ...
    static private int[]	parameters = 	{ 0, 2, 4, 6, 8, 10, 12, 14, 15, 16, 17, 18, 19, 21, 23, 25, 27, 29, 31, 33, 34,
            ...
            174, 175, 177, 178, 180, 181, 183, 184, 185, 187, 188, 190, 191, 192, 194, 196, 197, 199, 201, 203, 204,
            206, 207, 209, 211, 213, 214, 216, 218, 219, 221, 222, 223, 225, 227, 229, 231, 232, 233, 235, 237, 238,
            240, 241, 249, 250, 252, 253, 294, 295, 296, 297, 299, 301, 302, 303, 304, 305, 307, 308, 310, 328, 330,
            332, 334, 336, 338, 340, 342, 344, 346, 348, 350, 352, 354, 358, 360, 362, 364, 365, 366, 367, 389, 393,
            394, 395, 396, 397 };
    static private int[]	modulateableParameters = 	{ 0, 2, 4, 6, 8, 10, 12, 19, 21, 23, 25, 27, 29, 31, 38, 40, 42, 44,
            ...
            297, 299, 301, 302, 305, 308, 310, 342, 344, 346, 348, 350, 352, 354, 358, 360, 362, 367, 389 };
          // TODO: globalParameters is still too short/wrong (multiple associations used here)
    static private int[]	globalParameters = 	{ 247, 248, 312, 313, 314, 315, 316, 317, 318, 319, 320, 321, 322, 323, 356, 391 };
    static private int[]	globalModulateableParameters = 	{ 247, 248, 356 };
    ...
    static private String[]	parameterGroups = 	{ "Cab", "Comb", "CS", "Echo", "Env A", "Env B", "Env C", "FB", "Flang",
            "Gap Filt", "MCM", "MCs", "Master", "Mixer", "Mono", "Osc A", "Osc B", "Part", "Reverb", "Scale",
            "Sh A", "Sh B", "Split", "SVF", "Unison" };
