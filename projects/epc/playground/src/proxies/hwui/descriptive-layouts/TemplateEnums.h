...
namespace DescriptiveLayouts
{
  ...
  ENUM(EventSources, uint8_t, Any, None, ParameterName, SliderRange, ParameterDisplayString, ParameterGroupName,
       ...
       Serial_FX_Imagestate, Layer_FX_TO_OUT_Visibility, Layer_FX_TO_OUT_Imagestate, Split_FX_TO_OUT_Imagestate,
       Split_FX_TO_OUT_Imagestate_flipped, Split_Arrows_To_FX_L_TO_R_I, Split_Arrows_To_FX_L_TO_R_II,
       Split_Arrows_To_FX_R_TO_L_I, Split_Arrows_To_FX_R_TO_L_II, Split_Arrows_FX_To_I, Split_Arrows_FX_To_II,
