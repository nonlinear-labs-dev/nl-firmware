...
{
  polytoFXI = addControl(new PNGControl({0, 10, 11, 7}, "Single_FX_I_Out.png"));
  polytoFXII = addControl(new PNGControl({0, 2, 11, 7}, "Single_FX_II_out.png"));

  FXI = addControl(new PNGControl({17, 0, 9, 9}, "Single_FX_I.png"));
  FXII = addControl(new PNGControl({17, 11, 9, 9}, "Single_FX_II.png"));

  fxIToOut = addControl(new PNGControl({28, 10, 11, 7}, "Single_FX_II_out_no_arrow.png"));
  fxIIToOut = addControl(new PNGControl({28, 4, 11, 7}, "Single_FX_I_Out_no_arrow.png"));
  arrowFromFX = addControl(new PNGControl({39, 8, 3, 5}, "Single_FX_Arrow.png"));
