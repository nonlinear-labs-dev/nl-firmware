...
Glib::ustring Preset::getDisplayNameWithSuffixes(bool addSpace) const
{
  ...
  auto scale = PresetPresenter::isScaleActive(this);
...
{
  auto concat = [](auto first, auto... rest)
  {
  ...
  const auto typeHashtag = "#" + toString(getType());
  return concat(typeHashtag, PresetPresenter::isMonoActive(this) ? "#Mono" : "#Poly",
                PresetPresenter::isUnisonActive(this) ? "#Unison" : "#1-voice",
                PresetPresenter::isScaleActive(this) ? "#Scale" : "#12-TET");
}
