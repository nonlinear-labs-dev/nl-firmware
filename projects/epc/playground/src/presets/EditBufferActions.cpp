    ...
    : super(parent, "/param-editor/")
{
  ...
  addAction("restore",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
  ...
  addAction("set-macrocontrol-info",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
              auto id = request->get("id");
  ...
  addAction("set-ribbon-touch-behaviour",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
              auto id = request->get("id");
  ...
  addAction("set-ribbon-return-mode",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
              auto id = request->get("id");
  ...
  addAction("randomize-sound",
            [&editBuffer](const std::shared_ptr<NetworkRequest>&) mutable
            {
              SoundUseCases soundUseCases { &editBuffer, editBuffer.getParent() };
              soundUseCases.randomizeSound();
            });

  addAction("init-sound",
            [&editBuffer](const std::shared_ptr<NetworkRequest>&) mutable
            {
              EditBufferUseCases useCase { editBuffer };
              useCase.initSound(Defaults::UserDefault);
  ...
  addAction("mute-part-unmute-other",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
              auto vg = to<VoiceGroup>(request->get("part"));
              EditBufferUseCases ebUseCases(editBuffer);
  ...
  addAction("set-modulation-limit",
            [&editBuffer](const std::shared_ptr<NetworkRequest>& request) mutable
            {
  ...
  addAction("recall-current-from-preset",
            [&editBuffer](auto request)
            {
              auto id = request->get("id");
              EditBufferUseCases ebUseCases(editBuffer);
  ...
  addAction("recall-mc-for-current-mod-param",
            [&editBuffer](auto request)
            {
              auto id = request->get("id");
              EditBufferUseCases ebUseCases(editBuffer);
  ...
  addAction("recall-mc-amount-for-current-mod-param",
            [&editBuffer](auto request)
            {
              auto id = request->get("id");
              EditBufferUseCases ebUseCases(editBuffer);
  ...
  addAction("load-selected-preset-part-into-editbuffer-part",
            [&editBuffer](auto request)
            {
  ...
  addAction("load-preset-part-into-editbuffer-part",
            [&editBuffer](auto request)
            {
              auto presetPart = to<VoiceGroup>(request->get("preset-part"));
