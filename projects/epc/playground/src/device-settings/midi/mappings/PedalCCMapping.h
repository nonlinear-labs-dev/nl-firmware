...
template <int tPedal> class PedalCCMapping : public MappingSetting<PedalCC>
{
 ...
 public:
  ...
  {
    static std::vector<Glib::ustring> retWithCCs
        = { "None",      "CC 01/33",  "CC 02/34",  "CC 03/35",  "CC 04/36",  "CC 05/37",  "CC 06/38", "CC 07/39",
            ...
            "CC 64 sw.", "CC 65 sw.", "CC 66 sw.", "CC 67 sw.", "CC 68 sw.", "CC 69 sw.", "CC 64 c.", "CC 65 c.",
            "CC 66 c.",  "CC 67 c.",  "CC 68 c.",  "CC 69 c." };

    static std::vector<Glib::ustring> retWithoutLSB
        = { "None",      "CC 01",     "CC 02",     "CC 03",     "CC 04",     "CC 05",     "CC 06",    "CC 07",
            "CC 08",     "CC 09",     "CC 10",     "CC 11",     "CC 12",     "CC 13",     "CC 14",    "CC 15",
