...
const std::vector<Glib::ustring>& BenderCCMapping::enumToDisplayString() const
{
  static std::vector<Glib::ustring> ret
      = { "None",     "Pitchbend", "CC 01/33", "CC 02/34", "CC 03/35", "CC 04/36", "CC 05/37", "CC 06/38", "CC 07/39",
          "CC 08/40", "CC 09/41",  "CC 10/42", "CC 11/43", "CC 12/44", "CC 13/45", "CC 14/46", "CC 15/47", "CC 16/48",
          "CC 17/49", "CC 18/50",  "CC 19/51", "CC 20/52", "CC 21/53", "CC 22/54", "CC 23/55", "CC 24/56", "CC 25/57",
          "CC 26/58", "CC 27/59",  "CC 28/60", "CC 29/61", "CC 30/62", "CC 31/63" };
