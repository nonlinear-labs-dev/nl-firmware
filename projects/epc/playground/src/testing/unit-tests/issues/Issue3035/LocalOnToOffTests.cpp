...
TEST_CASE("Issue 3035, Pedal [Stay] Local On to Local Off")
{
...
TEST_CASE("Issue 3035, Pedal [Returning Zero] Local On to Local Off")
{
  auto eb = TestHelper::getEditBuffer();
  TestHelper::initSingleEditBuffer();
...
TEST_CASE("Issue 3035, Pedal [Returning Center] Local On to Local Off")
{
  auto eb = TestHelper::getEditBuffer();
  TestHelper::initSingleEditBuffer();
...
TEST_CASE("Issue 3035, Ribbon [Stay] Local On to Local Off")
{
  auto eb = TestHelper::getEditBuffer();
  TestHelper::initSingleEditBuffer();
...
//Bender
TEST_CASE("Issue 3035, Bender Local On to Local Off")
{
  auto eb = TestHelper::getEditBuffer();
  TestHelper::initSingleEditBuffer();
