...
#define test_initialize_time 1  // leave at 1 until Playcontroller transmits full init sequence (including time)
#define test_initialize_fx_sends                                                                                       \
  1  // leave at 1 until Playcontroller can handle fx sends (echo, reverb) (inits sends to 100%, maintaining compability)
...
/* Main Parameter Definition                        -> see Linux Engine Playcontroller Status */

#define sig_number_of_params 198        // see Linux Engine Playcontroller Status / Overview, Parameter List
...
/* Main Parameter Definition                        -> see Linux Engine 1.55 Playcontroller Status */

#define sig_number_of_params 197        // see Linux Engine 1.55 Playcontroller Status / Overview, Parameter List
...
/* Main Parameter Definition                        -> see Linux Engine 1.56 Playcontroller Status */

#define sig_number_of_params 195        // see Linux Engine 1.56 Playcontroller Status / Overview, Parameter List
