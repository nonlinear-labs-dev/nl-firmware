...
public class VoiceGroupMasterColumn extends ParameterColumn {
    ...
    private class PartTune extends ModulatableParameter {
        public PartTune(MapsLayout parent, int num) {
            super(parent, num);
            addChild(new Spacer(this, 40, 5));
    ...
    public VoiceGroupMasterColumn(MapsLayout parent) {
        ...
        addChild(new ModulationSourceSlider(this, 356));
    }
