...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.nonmaps=");
    idx += (13 + "nonmaps".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/nonmaps/_sourcemap.json 
//# sourceURL=nonmaps-0.js
