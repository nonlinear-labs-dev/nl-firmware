...
uint16_t CLEARALL_DATA[] = {
  // clang-format off
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xF800,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xF900,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFA00,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFB00,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFC00,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFD00,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFE00,
  PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, PLAYCONTROLLER_EHC_COMMAND_SET_CONTROL_REGISTER, 0xFF00,
  // clang-format on
};
uint16_t ENDIS_DATA[] = { PLAYCONTROLLER_BB_MSG_TYPE_SETTING, 0x0002, PLAYCONTROLLER_SETTING_ID_ENABLE_EHC, 0x0000 };
uint16_t CMD_DATA[]   = { PLAYCONTROLLER_BB_MSG_TYPE_EHC_CONFIG, 0x0002, 0x0000, 0x0000 };
...
int main(int argc, char const *argv[])
{
  ...
  if (strncmp(argv[1], RANGE, sizeof RANGE) == 0)
  {
    ...
    CMD_DATA[2] |= PLAYCONTROLLER_EHC_COMMAND_SET_RANGE_MIN;
    ...
    CMD_DATA[2] &= 0x00FF;
    CMD_DATA[2] |= PLAYCONTROLLER_EHC_COMMAND_SET_RANGE_MAX;
  ...
  if (strncmp(argv[1], DEADZONE, sizeof DEADZONE) == 0)
  {
    ...
    CMD_DATA[2] = readPortID(argv[2]);
    CMD_DATA[2] |= PLAYCONTROLLER_EHC_COMMAND_SET_DEAD_ZONES;
  ...
  if (strncmp(argv[1], RESET, sizeof RESET) == 0)
  {
    ...
    CMD_DATA[2] = readPortID(argv[2]);
    CMD_DATA[2] |= PLAYCONTROLLER_EHC_COMMAND_RESET_DELETE;
    CMD_DATA[3] = 0;
    writeData(driver, sizeof CMD_DATA, &CMD_DATA[0]);
    return 0;
  }
  ...
  if (strncmp(argv[1], FORCE, sizeof FORCE) == 0)
  {
    ...
    CMD_DATA[2] = readPortID(argv[2]);
    CMD_DATA[2] |= PLAYCONTROLLER_EHC_COMMAND_FORCE_OUTPUT;
    CMD_DATA[3] = 0;
    writeData(driver, sizeof CMD_DATA, &CMD_DATA[0]);
    return 0;
  }
