/***********************************************************************
 * $Id: usbd.h 6952 2011-03-23 22:26:42Z usb10131 $
 *
 * Project: USB device ROM stack
 *
 * Description: USB descriptor structure definitions.
 *
...
/** CDC-Data class  */
#define USB_DEVICE_CLASS_CDC_DATA_INTERFACE 0x0A
...
PRE_PACK struct POST_PACK _USB_INTERFACE_ASSOCIATION_DESCRIPTOR
{
  ...
  uint8_t bInterfaceCount;   /**< Interface count*/
