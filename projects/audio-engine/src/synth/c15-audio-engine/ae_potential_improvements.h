...
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_STD_ABS __POTENTIAL_IMPROVEMENT_ENABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_STD_MIN __POTENTIAL_IMPROVEMENT_ENABLED__
...
// - so far, provided functions outside std namespace of ParallelData.h have been potentially optimized
