...
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_STD_ABS __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_STD_MINMAX_FLOAT __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_STD_ROUND __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_KEEP_FRACTIONAL __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_SINP3_WRAP __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_SINP3_NOWRAP __POTENTIAL_IMPROVEMENT_DISABLED__
#define POTENTIAL_IMPROVEMENT_PARALLEL_DATA_THREE_RANGES __POTENTIAL_IMPROVEMENT_DISABLED__
