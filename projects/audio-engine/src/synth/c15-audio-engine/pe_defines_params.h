...
const ParameterDefinition param_definition[sig_number_of_params] = {
  ...
  { 213, Parameters::P_FLA_PHS, ClockTypes::Slow, PolyTypes::Mono, 80, 0, 0, Signals::Invalid, SpreadTypes::Single, 0,
  ...
  { 213, Parameters::P_FLA_PHS, ClockTypes::Audio, PolyTypes::Mono, 80, 0, 0, Signals::Invalid, SpreadTypes::Single, 0,
    14400 },  // 163 FLANGER_PHASE
#endif
  ...
  { 307, Parameters::P_FLA_ENV, ClockTypes::Slow, PolyTypes::Mono, 16000, 0, 0, Signals::Invalid, SpreadTypes::Single,
...
//       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
  ...
  { 235, Parameters::P_REV_SIZE, ClockTypes::Fast, PolyTypes::Mono, 16000, 0, 0, Signals::Invalid, SpreadTypes::Single,
    0, 16000 },  // 181 REVERB_SIZE
  { 237, Parameters::P_REV_PRE, ClockTypes::Fast, PolyTypes::Mono, 16000, 5, 0, Signals::Invalid, SpreadTypes::Single,
    0, 16000 },  // 182 REVERB_PRE_DELAY
  { 238, Parameters::P_REV_COL, ClockTypes::Fast, PolyTypes::Mono, 16000, 0, 0, Signals::Invalid, SpreadTypes::Single,
...
//       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
  ...
  { 400, Parameters::P_KEY_PH, ClockTypes::Sync, PolyTypes::Poly, 14400, 0, 0, Signals::Invalid, SpreadTypes::Single, 1,
    7200 },  // 194 KEY_UNISON_PHASE
  { 406, Parameters::P_KEY_NP, ClockTypes::Sync, PolyTypes::Poly, 1000, 0, 0, Signals::Invalid, SpreadTypes::Single, 1,
    1000 },  // 195 KEY_NOTE_PITCH
  { 407, Parameters::P_KEY_VP, ClockTypes::Sync, PolyTypes::Poly, 8000, 0, 0, Signals::Invalid, SpreadTypes::Single, 1,
    8000 },  // 196 KEY_VOICE_PAN
  { 409, Parameters::P_KEY_VS, ClockTypes::Sync, PolyTypes::Poly, 1, 0, 0, Signals::Invalid, SpreadTypes::Single, 0,
    1 }  // 197 KEY_VOICE_STEAL
  ...
  { 417, Parameters::P_KEY_IDX, ClockTypes::Sync, PolyTypes::Poly, 1, 0, 0, Signals::Invalid, SpreadTypes::Single, 0,
    1 },  // 195 KEY_UNISON_IDX
  { 418, Parameters::P_KEY_STL, ClockTypes::Sync, PolyTypes::Poly, 1, 0, 0, Signals::Invalid, SpreadTypes::Single, 0,
    1 }  // 196 KEY_VOICE_STEAL
