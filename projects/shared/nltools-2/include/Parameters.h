...
namespace nltools
{
  ...
  namespace controls
  {
    ...
    namespace detail
    {
      ...
      template <Type T> struct Parameter : public Control
      {
      ...
      template <Type T> struct HardwareSource : public Parameter<T>
      {
        static_assert(T == Type::Hardware_Source || T == Type::Display_Parameter, "HardwareSource type is restricted");
      ...
      template <Type T> struct Modulateable : public Parameter<T>
      {
        static_assert(T == Type::Global_Modulateable || T == Type::Polyphonic_Modulateable
                          || T == Type::Monophonic_Modulateable,
      ...
      template <Type T> struct Unmodulateable : public Parameter<T>
      {
        static_assert(T == Type::Global_Unmodulateable || T == Type::Polyphonic_Unmodulateable
                          || T == Type::Monophonic_Unmodulateable,
