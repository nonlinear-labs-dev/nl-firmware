    ...
    {                                                                                                                  \
      ...
      {                                                                                                                \
        ...
        {                                                                                                              \
          ...
          using expander = int[];                                                                                      \
          (void) expander { (                                                                                          \
              reg_test(Types {}, Catch::NameAndTags { Name " - " + std::string(tmpl_types[index]), Tags }), index++,   \
              0)... }; /* NOLINT */                                                                                    \
        }                                                                                                              \
      };                                                                                                               \
...
namespace Catch
{
  namespace Benchmark
  {
    namespace Detail
    {
      ...
      template <typename Clock, typename Fun>
      TimingOf<Clock, Fun(run_for_at_least_argument_t<Clock, Fun>)> run_for_at_least(ClockDuration<Clock> how_long,
                                                                                     int seed, Fun&& fun)
      {
        auto iters = seed;
        while(iters < (1 << 30))
