...
namespace C15
{
  ...
  const ParameterDescriptor ParameterList[Config::tcd_elements] = {
    ...
    { Parameters::Local_Unmodulateables::Env_A_Rel_Vel,
      PID::Env_A_Rel_Vel,
      0.0f,
      { Smoothers::Poly_Sync::Env_A_Rel_Vel, None, Properties::SmootherScale::Linear, 60.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Env_A_Time_KT,
      PID::Env_A_Time_KT,
      0.05f,
      { Smoothers::Poly_Sync::Env_A_Time_KT, None, Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Env_B_Rel_Vel,
      PID::Env_B_Rel_Vel,
      0.0f,
      { Smoothers::Poly_Sync::Env_B_Rel_Vel, None, Properties::SmootherScale::Linear, 60.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Env_B_Time_KT,
      PID::Env_B_Time_KT,
      0.05f,
      { Smoothers::Poly_Sync::Env_B_Time_KT, None, Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Env_C_Rel_Vel,
      PID::Env_C_Rel_Vel,
      0.0f,
      { Smoothers::Poly_Sync::Env_C_Rel_Vel, None, Properties::SmootherScale::Linear, 60.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Env_C_Time_KT,
      PID::Env_C_Time_KT,
      0.05f,
      { Smoothers::Poly_Sync::Env_C_Time_KT, None, Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
    ...
    { Parameters::Local_Unmodulateables::Osc_A_Pitch_KT,
      PID::Osc_A_Pitch_KT,
      0.5f,
      { Smoothers::Poly_Slow::Osc_A_Pitch_KT, None, Properties::SmootherScale::Linear, 2.0f, 0.0f, false },
      { 200, 20000, None, None, "", "Oscillator A", "Oscillator A", "Pitch - Key Trk", "Key Trk",
    ...
    { Parameters::Local_Modulateables::Osc_A_Pitch_Env_C,
      ...
      { 80, 8000, 80, 8000, "", "Oscillator A", "Oscillator A", "Pitch - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::Osc_A_Fluct_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "Fluct - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::Osc_A_PM_Self_Env_A,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "PM Self - Env A", "Env A",
    ...
    { Parameters::Local_Modulateables::Osc_A_PM_Self_Shp,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "PM Self - Shaper", "Shaper",
    ...
    { Parameters::Local_Modulateables::Osc_A_PM_B_Env_B,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "PM B - Env B", "Env B",
    ...
    { Parameters::Local_Modulateables::Osc_A_PM_B_Shp,
      ...
      { Smoothers::Poly_Slow::Osc_A_PM_B_Shp, Signals::Quasipoly_Signals::Osc_A_PM_B_Shp,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "PM B - Shaper", "Shaper",
    ...
    { Parameters::Local_Modulateables::Osc_A_PM_FB_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator A", "Oscillator A", "PM FB - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::Shp_A_Drive_Env_A,
      ...
      { 100, 1000, 100, 1000, "", "Shaper A", "Shaper A", "Drive - Env A", "Env A",
    ...
    { Parameters::Local_Modulateables::Shp_A_FB_Env_C,
      PID::Shp_A_FB_Env_C,
      0.0f,
      { Smoothers::Poly_Slow::Shp_A_FB_Env_C, None, Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
      { 100, 1000, 100, 1000, "", "Shaper A", "Shaper A", "FB - Gate-Env C", "G-Env C",
    ...
    { Parameters::Local_Unmodulateables::Osc_B_Pitch_KT,
      PID::Osc_B_Pitch_KT,
      0.5f,
      { Smoothers::Poly_Slow::Osc_B_Pitch_KT, None, Properties::SmootherScale::Linear, 2.0f, 0.0f, false },
      { 200, 20000, None, None, "", "Oscillator B", "Oscillator B", "Pitch - Key Trk", "Key Trk",
        "Key tracking of the oscillator pitch. It's the scaling factor between "
        "the key position of a received MIDI note (relative to C3 = 60 "
        "semitones) and the pitch of the oscillator.\nAt 100.0 %, the pitch "
        "follows the equal-tempered scale (when the Scale group is "
    ...
    { Parameters::Local_Modulateables::Osc_B_Pitch_Env_C,
      ...
      { 80, 8000, 80, 8000, "", "Oscillator B", "Oscillator B", "Pitch - Env C", "Env C",
        "Amount of pitch modulation by Envelope C [in semitones]." } },
    ...
    { Parameters::Local_Modulateables::Osc_B_Fluct_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "Fluct - Env C", "Env C",
        "Amount of modulation of the frequency fluctuation by Envelope C. At "
        "zero, the modulation stays constant, at higher values, the envelope "
        "applies a time-variant attenuation." } },
    ...
    { Parameters::Local_Modulateables::Osc_B_PM_Self_Env_B,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "PM Self - Env B", "Env B",
    ...
    { Parameters::Local_Modulateables::Osc_B_PM_Self_Shp,
      ...
      { Smoothers::Poly_Slow::Osc_B_PM_Self_Shp, Signals::Quasipoly_Signals::Osc_B_PM_Self_Shp,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "PM Self - Shaper", "Shaper",
    ...
    { Parameters::Local_Modulateables::Osc_B_PM_A_Env_A,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "PM A - Env A", "Env A",
    ...
    { Parameters::Local_Modulateables::Osc_B_PM_A_Shp,
      ...
      { Smoothers::Poly_Slow::Osc_B_PM_A_Shp, Signals::Quasipoly_Signals::Osc_B_PM_A_Shp,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "PM A - Shaper", "Shaper",
    ...
    { Parameters::Local_Modulateables::Osc_B_PM_FB_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "Oscillator B", "Oscillator B", "PM FB - Env C", "Env C",
        "Envelope (C) amount for the phase modulation by the Feedback signal. At "
        "zero, the modulation stays constant, at higher values, the envelope "
        "applies a time-variant attenuation." } },
    ...
    { Parameters::Local_Modulateables::Shp_B_Drive_Env_B,
      ...
      { 100, 1000, 100, 1000, "", "Shaper B", "Shaper B", "Drive - Env B", "Env B",
    ...
    { Parameters::Local_Modulateables::Shp_B_FB_Env_C,
      PID::Shp_B_FB_Env_C,
      0.0f,
      { Smoothers::Poly_Slow::Shp_B_FB_Env_C, None, Properties::SmootherScale::Linear, 1.0f, 0.0f, true },
      { 100, 1000, 100, 1000, "", "Shaper B", "Shaper B", "FB - Gate-Env C", "G-Env C",
        "Envelope (C) amount for the Feedback Mix. At zero, only a Gate signal "
        "is applied, at higher values, Envelope C is faded in. At negative "
        "values, the Gate signal is faded out, allowing for permanent feedback "
        "at the minimum." } },
    ...
    { Parameters::Local_Unmodulateables::Comb_Flt_Pitch_KT,
      ...
      0.5f,
      { Smoothers::Poly_Slow::Comb_Flt_Pitch_KT, None, Properties::SmootherScale::Linear, 2.0f, 0.0f, false },
      { 200, 20000, None, None, "", "Comb Filter", "Comb Filter", "Pitch - Key Trk", "Key Trk",
    ...
    { Parameters::Local_Modulateables::Comb_Flt_Pitch_Env_C,
      ...
      { 80, 8000, 80, 8000, "", "Comb Filter", "Comb Filter", "Pitch - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::Comb_Flt_AP_Env_C,
      ...
      { 80, 800, 80, 800, "", "Comb Filter", "Comb Filter", "Allpass - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::Comb_Flt_LP_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "Comb Filter", "Comb Filter", "Hi Cut - Env C ", "Env C",
    ...
    { Parameters::Local_Modulateables::Comb_Flt_PM_A_B,
      ...
      { Smoothers::Poly_Slow::Comb_Flt_PM_A_B, Signals::Quasipoly_Signals::Comb_Flt_PM_A_B,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Comb Filter", "Comb Filter", "PM - A-B", "A - B",
    ...
    { Parameters::Local_Unmodulateables::SV_Flt_Cut_KT,
      PID::SV_Flt_Cut_KT,
      0.5f,
      { Smoothers::Poly_Slow::SV_Flt_Cut_KT, None, Properties::SmootherScale::Linear, 2.0f, 0.0f, false },
      { 200, 2000, None, None, "", "State Variable Filter", "SV Filter", "Cutoff - Key Trk", "Key Trk",
    ...
    { Parameters::Local_Modulateables::SV_Flt_Cut_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "State Variable Filter", "SV Filter", "Cutoff - Env C", "Env C",
    ...
    { Parameters::Local_Modulateables::SV_Flt_Res_Env_C,
      ...
      { 100, 1000, 100, 1000, "", "State Variable Filter", "SV Filter", "Reson - Env C ", "Env C",
    ...
    { Parameters::Local_Modulateables::SV_Flt_Par,
      ...
      { 100, 1000, 100, 1000, "", "State Variable Filter", "SV Filter", "Parallel", "Parallel ",
    ...
    { Parameters::Local_Modulateables::SV_Flt_FM_A_B,
      ...
      { Smoothers::Poly_Slow::SV_Flt_FM_A_B, Signals::Quasipoly_Signals::SV_Flt_FM_A_B,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "State Variable Filter", "SV Filter", "FM - A-B", "A - B",
    ...
    { Parameters::Local_Modulateables::FB_Mix_Asym,
      ...
      { Smoothers::Poly_Fast::FB_Mix_Asym, Signals::Quasipoly_Signals::FB_Mix_Asym, Properties::SmootherScale::Linear,
        1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Feedback Mixer", "FB Mixer", "Asymmetry", "Asym",
        "Asymmetry of the shaper curve, generating even (2nd, 4th, ...) "
        "harmonics. At higher values, it becomes a parabolic curve that shifts "
        "the frequency of the fundamental to its double." } },
    ...
    { Parameters::Local_Modulateables::Out_Mix_A_Pan,
      ...
      { 100, 1000, 100, 1000, "", "Output Mixer", "Output Mixer", "A - Pan", "Pan",
    ...
    { Parameters::Local_Modulateables::Out_Mix_B_Pan,
      ...
      { 100, 1000, 100, 1000, "", "Output Mixer", "Output Mixer", "B - Pan", "Pan",
    ...
    { Parameters::Local_Modulateables::Out_Mix_Comb_Pan,
      ...
      { 100, 1000, 100, 1000, "", "Output Mixer", "Output Mixer", "Comb - Pan", "Pan",
    ...
    { Parameters::Local_Modulateables::Out_Mix_SVF_Pan,
      ...
      { 100, 1000, 100, 1000, "", "Output Mixer", "Output Mixer", "SV Filter - Pan", "Pan",
    ...
    { Parameters::Local_Modulateables::Out_Mix_Asym,
      ...
      { Smoothers::Poly_Fast::Out_Mix_Asym, Signals::Quasipoly_Signals::Out_Mix_Asym, Properties::SmootherScale::Linear,
        1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Output Mixer", "Output Mixer", "Asymmetry", "Asym",
        "Asymmetry of the shaper curve, generating even (2nd, 4th, ...) "
        "harmonics. At higher values, it becomes a parabolic curve that shifts "
        "the frequency of the fundamental to its double." } },
    ...
    { Parameters::Local_Unmodulateables::Out_Mix_Key_Pan,
      PID::Out_Mix_Key_Pan,
      0.0f,
      { Smoothers::Poly_Fast::Out_Mix_Key_Pan, None, Properties::SmootherScale::Linear, 1.0f / 60.0f, 0.0f, true },
    ...
    { Parameters::Local_Modulateables::Gap_Flt_Res,
      ...
      { Smoothers::Mono_Slow::Gap_Flt_Res, Signals::Mono_Signals::Gap_Flt_Res, Properties::SmootherScale::Linear, 0.9f,
        0.0f, false },
      { 100, 1000, 100, 1000, "", "Gap Filter", "Gap Filter", "Resonance", "Reson",
    ...
    { Parameters::Macro_Controls::MC_A,
      ...
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:A", "@MC:A", "" } },
    { Parameters::Macro_Controls::MC_B,
      PID::MC_B,
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:B", "@MC:B", "" } },
    { Parameters::Macro_Controls::MC_C,
      PID::MC_C,
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:C", "@MC:C", "" } },
    { Parameters::Macro_Controls::MC_D,
      PID::MC_D,
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:D", "@MC:D", "" } },
    ...
    { Parameters::Local_Modulateables::Unison_Detune,
      PID::Unison_Detune,
      50.0f / 24000.0f,
      { Smoothers::Poly_Slow::Unison_Detune, None, Properties::SmootherScale::Linear, 24.0f, 0.0f, false },
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:A", "Ped 1 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:B", "Ped 1 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:C", "Ped 1 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:D", "Ped 1 to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:A", "Ped 2 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:B", "Ped 2 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:C", "Ped 2 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:D", "Ped 2 to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:A", "Ped 3 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:B", "Ped 3 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:C", "Ped 3 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:D", "Ped 3 to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:A", "Ped 4 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:B", "Ped 4 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:C", "Ped 4 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:D", "Ped 4 to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:A", "Bend to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:B", "Bend to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:C", "Bend to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:D", "Bend to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:A", "AT to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:B", "AT to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:C", "AT to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:D", "AT to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:A", "Rib 1 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:B", "Rib 1 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:C", "Rib 1 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:D", "Rib 1 to @MC:D",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_A,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:A", "Rib 2 to @MC:A",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_B,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:B", "Rib 2 to @MC:B",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_C,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:C", "Rib 2 to @MC:C",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_D,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:D", "Rib 2 to @MC:D",
    ...
    { Parameters::Local_Modulateables::Env_A_Att_Curve,
      ...
      { 100, 1000, 100, 1000, "", "Envelope A", "Envelope A", "Attack Curve", "Curve",
    ...
    { Parameters::Local_Modulateables::Env_B_Att_Curve,
      ...
      { 100, 1000, 100, 1000, "", "Envelope B", "Envelope B", "Attack Curve", "Curve",
        "Curvature of the (polynomial) Attack segment. (negative: decelerating "
        "slope, zero: linear, positive: accelerating slope)" } },
    { Parameters::Local_Modulateables::Env_C_Att_Curve,
      ...
      { 100, 1000, 100, 1000, "", "Envelope C", "Envelope C", "Attack Curve", "Curve",
        "Curvature of the (polynomial) Attack segment. (negative: decelerating "
        "slope, zero: linear, positive: accelerating slope)" } },
    ...
    { Parameters::Global_Modulateables::Scale_Offset_10,
      ...
      { Smoothers::Global_Slow::Scale_Offset_10, Signals::Global_Signals::Scale_Offset_10,
        Properties::SmootherScale::Linear, 12.0f, 0.0f, true },
      { 1200, 12000, 1200, 12000, "", "Scale", "Scale", "Offset +10", "Offset +10",
    ...
    { Parameters::Global_Modulateables::Scale_Offset_11,
      ...
      { Smoothers::Global_Slow::Scale_Offset_11, Signals::Global_Signals::Scale_Offset_11,
        Properties::SmootherScale::Linear, 12.0f, 0.0f, true },
      { 1200, 12000, 1200, 12000, "", "Scale", "Scale", "Offset +11", "Offset +11",
    ...
    { Parameters::Macro_Times::MC_Time_A,
      ...
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:A Smoothing", "Smoothing",
    ...
    { Parameters::Macro_Times::MC_Time_B,
      ...
      0.4f,
      { None, None, Properties::SmootherScale::Expon_Env_Time, 1.0f, -20.0f, false },
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:B Smoothing", "Smoothing",
        "Sets the smoothing time [in milliseconds] for modulations on target "
    ...
    { Parameters::Macro_Times::MC_Time_C,
      ...
      0.4f,
      { None, None, Properties::SmootherScale::Expon_Env_Time, 1.0f, -20.0f, false },
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:C Smoothing", "Smoothing",
        "Sets the smoothing time [in milliseconds] for modulations on target "
    ...
    { Parameters::Macro_Times::MC_Time_D,
      ...
      0.4f,
      { None, None, Properties::SmootherScale::Expon_Env_Time, 1.0f, -20.0f, false },
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:D Smoothing", "Smoothing",
        "Sets the smoothing time [in milliseconds] for modulations on target "
    ...
    { Parameters::Local_Modulateables::Env_A_Elevate,
      ...
      { 100, 1000, 100, 1000, "", "Envelope A", "Envelope A", "Elevate T - A", "Elevate",
    ...
    { Parameters::Local_Modulateables::Env_B_Elevate,
      ...
      { 100, 1000, 100, 1000, "", "Envelope B", "Envelope B", "Elevate T - A", "Elevate",
        "Transforms the breakpoints of the Envelope signal, becoming more and "
        "more a flat organ-like curve towards the control's edges. At negative "
        "values, the Timbre part will be affected, controlling Phase Modulations "
        "and Shaper Drives. At positive values, the Amplitude part will be "
    ...
    { Parameters::Local_Modulateables::FB_Mix_Comb_Src,
      ...
      { Smoothers::Poly_Fast::FB_Mix_Comb_Src, Signals::Quasipoly_Signals::FB_Mix_Comb_Src,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Feedback Mixer", "FB Mixer", "Comb - From @VG:Other", "From @VG:Other",
    ...
    { Parameters::Local_Modulateables::FB_Mix_SVF_Src,
      ...
      { Smoothers::Poly_Fast::FB_Mix_SVF_Src, Signals::Quasipoly_Signals::FB_Mix_SVF_Src,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Feedback Mixer", "FB Mixer", "SV Filter - From @VG:Other", "From @VG:Other",
    ...
    { Parameters::Local_Modulateables::FB_Mix_FX_Src,
      ...
      { Smoothers::Poly_Fast::FB_Mix_FX_Src, Signals::Quasipoly_Signals::FB_Mix_FX_Src,
        Properties::SmootherScale::Linear, 1.0f, 0.0f, false },
      { 100, 1000, 100, 1000, "", "Feedback Mixer", "FB Mixer", "Effects - From @VG:Other", "From @VG:Other",
    ...
    { Parameters::Local_Modulateables::Out_Mix_To_FX,
      ...
      { 100, 1000, 100, 1000, "0", "Output Mixer", "Output Mixer", "To FX @VG:Other", "To FX @VG:Other",
    ...
    { Parameters::Macro_Controls::MC_E,
      ...
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:E", "@MC:E", "" } },
    { Parameters::Macro_Times::MC_Time_E,
      PID::MC_Time_E,
      0.4f,
      { None, None, Properties::SmootherScale::Expon_Env_Time, 1.0f, -20.0f, false },
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:E Smoothing", "Smoothing",
        "Sets the smoothing time [in milliseconds] for modulations on target "
    ...
    { Parameters::Macro_Controls::MC_F,
      ...
      0.5f,
      {},
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:F", "@MC:F", "" } },
    { Parameters::Macro_Times::MC_Time_F,
      PID::MC_Time_F,
      0.4f,
      { None, None, Properties::SmootherScale::Expon_Env_Time, 1.0f, -20.0f, false },
      { 100, 1000, None, None, "", "Macro Control", "Macro Control", "@MC:F Smoothing", "Smoothing",
        "Sets the smoothing time [in milliseconds] for modulations on target "
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:E", "Ped 1 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Pedal_1_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 1 to @MC:F", "Ped 1 to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:E", "Ped 2 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Pedal_2_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 2 to @MC:F", "Ped 2 to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:E", "Ped 3 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Pedal_3_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 3 to @MC:F", "Ped 3 to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:E", "Ped 4 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Pedal_4_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Pedal 4 to @MC:F", "Ped 4 to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:E", "Bend to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Bender_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Bender to @MC:F", "Bend to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:E", "AT to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Aftertouch_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Aftertouch to @MC:F", "AT to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:E", "Rib 1 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Ribbon_1_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 1 to @MC:F", "Rib 1 to @MC:F",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_E,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:E", "Rib 2 to @MC:E",
    ...
    { Parameters::Hardware_Amounts::Ribbon_2_to_MC_F,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Amount", "HW Amount", "Ribbon 2 to @MC:F", "Rib 2 to @MC:F",
    ...
    { Parameters::Display_Parameters::Pedal_1_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Pedal 1 Send", "Pedal 1 Snd",
    ...
    { Parameters::Display_Parameters::Pedal_2_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Pedal 2 Send", "Pedal 2 Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Pedal_3_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Pedal 3 Send", "Pedal 3 Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Pedal_4_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Pedal 4 Send", "Pedal 4 Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Bender_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Bender Send", "Bender Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Aftertouch_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Aftertouch Send", "Aftertouch Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Ribbon_1_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Ribbon 1 Send", "Ribbon 1 Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
    ...
    { Parameters::Display_Parameters::Ribbon_2_Send,
      ...
      0.0f,
      {},
      { 100, 1000, None, None, "", "Hardware Source", "HW Source", "Ribbon 2 Send", "Ribbon 2 Snd",
        "When Local is disabled in the MIDI Settings, this control is the "
