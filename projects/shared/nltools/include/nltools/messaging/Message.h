...
namespace nltools
{
  namespace msg
  {
    ...
    struct SinglePresetMessage
    {
      ...
      std::array<ParameterGroups::ModulateableParameter, 161> modulateables;
      std::array<ParameterGroups::UnmodulateableParameter, 37> unmodulateables;
    ...
    struct SplitPresetMessage
    {
      ...
      std::array<std::array<ParameterGroups::ModulateableParameter, 161>, 2> modulateables;
      std::array<std::array<ParameterGroups::UnmodulateableParameter, 37>, 2> unmodulateables;
