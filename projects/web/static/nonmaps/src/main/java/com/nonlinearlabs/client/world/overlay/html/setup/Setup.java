...
public class Setup extends Composite {
	...
	@UiField
	Button deviceSettingsButton, uiSettingsButton, uiMidiButton, uiFlacButton, systemInfoButton, aboutButton, chooseFileButton, toggleTestTone, loadFactoryDefaults;
